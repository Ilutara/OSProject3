...
class NodeCache:
    ...
    def get(self, block_id):
        ...
        node = BNode.decode(block_id, data)
        ...
        match cmd:
            ...
            case "load":
                ...
                if not os.path.exists(csv_path):
                    raise RuntimeError(f"Error: CSV file '{csv_path}' does not exist")
                try:
            ...
            case "extract":
                ...
                try:
                    with open(out_csv, "w", newline="") as f:
                        writer = csv.writer(f)
                        btree.inorder_traverse(lambda k, v: writer.writerow([k, v]))
                finally:
                    btree.close()
            case _:
